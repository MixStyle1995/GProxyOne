...
public:
	...
	void SetTimerReconnect(uint32_t nTimer)					{ nTimerReconnect = nTimer; }
	...
	void SetSearchGameName( string nSearchGameName )		{ m_SearchGameName.push_back(nSearchGameName); m_SearchGameNameTime = GetTime( ); }
