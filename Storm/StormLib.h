...
bool   WINAPI SFileOpenArchiveEx(const void* pBuffer, DWORD dwBufferSize, DWORD dwPriority, DWORD dwFlags, HANDLE* phMpq);
...
bool    WINAPI SafeCloseArchive(HANDLE hMpq);
